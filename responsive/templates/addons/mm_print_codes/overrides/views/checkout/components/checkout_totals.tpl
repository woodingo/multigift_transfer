    ...
    <div class="ty-cart-total__wrapper clearfix" id="checkout_totals">
        ...
        <ul class="ty-cart-statistic__total-list">
            <li class="ty-cart-statistic__item ty-cart-statistic__total">
                <span class="ty-cart-statistic__total-title">{__("total_cost")}</span> {* Edit by mashmedia: $cart.total already contains $cart.shipping_cost *}
                {* <span class="ty-cart-statistic__total-value">{include file="common/price.tpl" value=$_total|default:$smarty.capture._total|default:$cart.total+$cart.shipping_cost span_id="cart_total" class="ty-price"}</span> *}
