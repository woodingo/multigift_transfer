...
{if !$simple_search_form}
    ...
    <div class="ty-control-group">
        <input type="checkbox" value="N" {if $search.hide_out_of_stock == "N"}checked="checked"{/if} name="hide_out_of_stock" id="hide_out_of_stock" class="checkbox ty-select-field__checkbox" />{__("mm_stock_filter_show_out_of_stock")}
    </div>
